...
void CCpuDepthRenderer::Process()
{
	if(m_bInitialized)
		return;
	m_bInitialized = true;
...
void CCpuDepthRenderer::Draw()
{
	...
	Vec t1(kk::scene::CArcCameraNode::XAxisWorld.X,kk::scene::CArcCameraNode::XAxisWorld.Y,kk::scene::CArcCameraNode::XAxisWorld.Z);
	Vec t2(kk::scene::CArcCameraNode::YAxisWorld.X,kk::scene::CArcCameraNode::YAxisWorld.Y,kk::scene::CArcCameraNode::YAxisWorld.Z);
	Vec t3(kk::scene::CArcCameraNode::ZAxisWorld.X,kk::scene::CArcCameraNode::ZAxisWorld.Y,kk::scene::CArcCameraNode::ZAxisWorld.Z);
	DrawingWrapper::DrawLine(Vec(0.5f,0.5f,0.5f),Vec(0.5f,0.5f,0.5f) + t1,255);
	DrawingWrapper::DrawLine(Vec(0.5f,0.5f,0.5f),Vec(0.5f,0.5f,0.5f) + t2,0,255);
	DrawingWrapper::DrawLine(Vec(0.5f,0.5f,0.5f),Vec(0.5f,0.5f,0.5f) + t3,0,0,255);
