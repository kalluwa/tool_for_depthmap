...
namespace core
{
	...
	*/
	...
	//if condition>0 then return a else return b
	//( -condition >> 31 )get the condition's inverse sign
	//[if condition>0 then bit32(condition)=0 else bit32(condition)=1]
